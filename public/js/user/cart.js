...
$('.quantity').change(function () {
  ...
  var subPrice = Intl.NumberFormat('de-DE').format(price * quantity);
  var itemId = $(this).parent().parent().find('input[name=itemId]').val();
  $(this).parent().parent().find('input[name=subPrice]').val(price * quantity);
  $(this).parent().parent().find('.subtotal-cart strong').text(subPrice + '$'); // Calculate total price for all product
...
function _saveData() {
  _saveData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(cartId, quantity) {
